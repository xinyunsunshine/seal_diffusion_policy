...
# Loop through episode indices 0 to 49
for x in {0..49}; do
    HYDRA_RUN_DIR="data/outputs/square/ftall0/sft${x}"
    LOG_NAME="square_training_all_sft${x}"

    echo "Training episode index: $x"
    ...
    python train.py \
        ...
        task.dataset.episode_indices="[$x]"
